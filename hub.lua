...
Tools[10].Grip = CFrame.new(19.0, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
Tools[10].Parent = plr.Character

Tools[11].Grip = CFrame.new(21.5, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
Tools[11].Parent = plr.Character

Tools[12].Grip = CFrame.new(24.0, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
Tools[12].Parent = plr.Character

Tools[13].Grip = CFrame.new(26.5, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
Tools[13].Parent = plr.Character

 Tools[14].Grip = CFrame.new(29.0, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
Tools[14].Parent = plr.Character
 
Tools[15].Grip = CFrame.new(31.5, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
Tools[15].Parent = plr.Character
 
Tools[16].Grip = CFrame.new(33.0, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
Tools[16].Parent = plr.Character
 
Tools[17].Grip = CFrame.new(35.5, -1.5, -1.3) * CFrame.Angles(1.6, math.rad(90), 3.16)
